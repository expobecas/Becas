...
$pdf->Cell(45, 6, 'Fecha del recibo', 1, 0, 'C', 1);
$pdf->Cell(45, 6, 'Empresa', 1, 0, 'C', 1);
$pdf->Cell(45, 6, 'Monto', 1, 0, 'C', 1);
$pdf->Cell(45, 6, 'Fecha de entrega', 1, 0, 'C', 1);
$pdf->Ln(6);

$datos = $pagos->getPagos();
foreach ($datos as $row) {
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont('Arial', '', 8);
    $pdf->SetX(15);
    $pdf->SetFillColor(255, 132, 124);
    $pdf->Cell(45, 6, $row['fecha_emi_recibo'], 1, 0, 'C',1);
    $pdf->SetFont('Arial', '', 7);
    $pdf->Cell(45, 6, $row['nombre_empresa'], 1, 0, 'C');
    $pdf->Cell(45, 6, $row['monto'], 1, 0, 'C');
    $pdf->SetFillColor(153, 184, 152);
    $pdf->Cell(45, 6, $row['fecha_entregado'], 1, 0, 'C',1);
