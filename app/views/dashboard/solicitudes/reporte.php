...
$poli = "
                ...
                DEL PROGRAMA DE CUOTA
                            DIFERENCIADA.";                                                            
$pdf->MultiCell(100,4,utf8_decode($poli),0,2,1);

$pdf->Ln(1);
$pdf->setX(166); 
$pdf->SetTextColor(99, 99, 99);
$politica = "- La cuota asignada a cada estudiante es determinada por
medio de la obtención del ingreso Per Capita, que es igual 
a la suma de todos los egresos, dividido entre el número
de miembros que conforman el grupo familiar.

- Los estudiantes no pagarán una cuota menos de la 
que pagaron en la insititución educativa de donde
proceden, salvo casos especiales.

- Todos los casos son evaluados rigurosamente y se incluye 
visita domiciliar para determinar la cuota definita.

-Cuando un alumno ya obtuvo beca no podrá dársela a
sus hermanos siguienes, para que la ayuda pase a
ser recibida por otras familias que igualmente
necesitan.

-4t año PILET no aplica al programa de becas.";                                                            
$pdf->MultiCell(100,4,utf8_decode($politica),0);
//GASTOS//
$pdf->setY(16);    
$pdf->SetFont('Arial','B',11);
$pdf->SetTextColor(99, 99, 99);
...
//GASTOS JUSTIFICADOS CON LOS MONTOS RESPECTIVOS
$pdf->Ln(6);
$pdf->SetFont('Arial','',10);
$pdf->setX(87);                                                               
...
=======
        ...
        $pdf->Output();
>>>>>>> 1b97651780f7b5293338850937a83f128fd4c65e
?>