<div class="row">
    ...
    <div class="row">
        ...
        <input name="patrocinador" id="patrocinador" type="text" class="validate" value='<?php print($comentarios->getPatrocinador())?>' required/>
        <label for="patrocinador">Codigo</label>
        </div>
      </div>
