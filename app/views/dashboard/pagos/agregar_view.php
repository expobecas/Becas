...
<div class="row">
   <form class="col s12 l7 offset-l4 white edit_form" method='POST' autocomplete="off">
      <p class="titulo-EP"><strong>Agregar pagos</strong></p>
         <div class="input-field col s4 l6">
            <input id="fecha1" name='fecha1' type="text" class="datepicker" value='<?php print($pagos->getFechaRecibo()) ?>' required/>
            <label for="fecha1">Fecha del recibo<i class='material-icons icon-form'>mail_outline</i></label>
         </div>
         <div class="row">
      <div class="input-field col s4 l6">
      <input id="fecha2" name='fecha2'  type="text" class="datepicker" value='<?php print($pagos->getFechaEntregado()) ?>' required/>
      <label for="fecha2">Fecha de entrega<i class='material-icons icon-form'>event</i></label>
   </div>
