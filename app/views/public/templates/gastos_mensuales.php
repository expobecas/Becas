<div class="row">
    ...
    <div class="input-field col s12 m6 l3"> 
        <input id="pago_deudas" type="text" name="pago_deudas" class="gastos validate">
        <label for="pago_deudas">Pago de deudas</label>
    </div>
    
    <div class="input-field col s12 m6 l3"> 
        <input id="cotizaciones" type="text" name="cotizaciones" class="gastos validate">
    ...
    <div class="input-field col s12 m6 l3"> 
        <input id="seguro_personal" type="text" name="seguro_personal" class="gastos validate">
        <label for="seguro_personal">Seguro personal</label>
    </div>

    <div class="input-field col s12 m6 l3"> 
        <input id="seguro_vehiculo" type="text" name="seguro_vehiculo" class="gastos validate">
        <label for="seguro_vehiculo">Seguro de vehiculo</label>
    </div>

    <div class="input-field col s12 m6 l3"> 
        <input id="seguro_inmuebles" type="text" name="seguro_inmuebles" class="gastos validate">
        <label for="seguro_inmuebles">Seguro de inmuebles</label>
    </div>

    <div class="input-field col s12 m6 l3"> 
        <input id="transporte" type="text" name="transporte" class="gastos validate">
        <label for="transporte">Transporte</label>
    </div>

    <div class="input-field col s12 m6 l3"> 
        <input id="mant_vehiculo" type="text" name="mant_vehiculo" class="gastos validate">
        <label for="mant_vehiculo">Gastos de mantenimiento de vehiculo</label>
    </div>

    <div class="input-field col s12 m6 l3"> 
        <input id="salud" type="text" name="salud" class="gastos validate">
        <label for="salud">Salud e Higiene</label>
    </div>

    <div class="input-field col s12 m6 l3"> 
        <input id="pago_asociaciones" type="text" name="pago_asociaciones" class="gastos validate">
    ...
    <div class="input-field col s12 m6 l3"> 
        <input id="pago_colegiatura" type="text" name="pago_colegiatura" class="gastos validate">
        <label for="pago_colegiatura">Pago de colegiaturas</label>
    </div>

    <div class="input-field col s12 m6 l3"> 
        <input id="pago_universitaros" type="text" name="pago_universitaros" class="gastos validate">
        <label for="pago_universitaros">Pago de cuotas universitarias</label>
    </div>

    <div class="input-field col s12 m6 l3"> 
        <input id="materiales" type="text" name="materiales" class="gastos validate">
    ...
    <div class="input-field col s12 m6 l3"> 
        <input id="iva" type="text" name="iva" class="gastos validate">
        <label for="iva">IVA</label>
    </div>

    <div class="input-field col s12 m6 l3"> 
        <input id="tarjetas_credito" type="text" name="tarjetas_credito" class="gastos validate">
        <label for="tarjetas_credito">Targetas de credito</label>
    </div>

    <div class="input-field col s12 m6 l3"> 
        <input id="otros_gastos" type="text" name="otros_gastos" class="gastos validate">
